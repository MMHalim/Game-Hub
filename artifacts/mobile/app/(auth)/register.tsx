      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={[styles.sub, { color: colors.mutedForeground }]}>3-day free trial, then choose your plan</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: "800", fontFamily: "Inter_700Bold", letterSpacing: -0.5 },
